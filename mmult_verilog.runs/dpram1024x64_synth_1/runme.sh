...
HD_PWD='C:/XilinxProjects/mmult_verilog/mmult_verilog.runs/dpram1024x64_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dpram1024x64.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dpram1024x64.tcl
